    ...
    <div className='container mx-auto h-screen pt-20 lg:pt-40 text-white px-5'>
        <div className='flex items-center justify-between w-full gap-4'>
            <div className='w-20 md:w-40 xl:w-80 rounded-full overflow-hidden'>
                <img className='' src={'./images/profile.jpg'} alt='Picture of Leo.' />
            </div>
            <div>
                <h1 className='text-4xl md:text-6xl lg:text-[6rem] xl:text-[8rem] 2xl:text-[10rem] 3xl:text-[12rem] 4xl:text-[15rem]'>
                    Leo Asadourian
                </h1>
                <p className='text-lg lg:text-xl xl:text-2xl md:px-1 xl:px-4 3xl:px-5'>Software Engineer (Photographer, Artist)</p>
            </div>
        </div>
        <div className='py-10 xl:py-20'>
            <h2 className='text-4xl underline mb-5'>Bio</h2>
            <BioRow year={"2017"} description={"Worked at Bestbuy as Salesman"}/>
            <BioRow year={"2021"} description={"Summer Intership at CT Software Solutions / Started Undergraduate Degree at CSUN"}/>
            <BioRow year={"2022"} description={"Started working at TSENG college at CSUN as tech support specialist"}/>
            <BioRow year={"2023"} description={"Graduated from CSUN with bachelor's degree in Computer Science"}/>
